...
class OccasionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\FileUpload::make('image_path')->image()->imageEditor()->disk('public')->directory('occasions'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image_path')->label('')->disk('public')->square()->size(36),
    ...
    {
        return ['index' => Pages\ListOccasions::route('/')];
    }
}
